-- Insert foundation shade data for existing products with corrected depth levels (1-10)
...
CROSS JOIN (
  VALUES 
    ...
    ('110 - Fair Light with cool undertones', '110', '#F0E2CD', ARRAY[240, 226, 205], 'cool', 1),
    ('120 - Fair Light with warm undertones', '120', '#EFE0CA', ARRAY[239, 224, 202], 'warm', 2),
    ('130 - Light with neutral undertones', '130', '#EBDCC6', ARRAY[235, 220, 198], 'neutral', 2),
    ('140 - Light with warm undertones', '140', '#E8D9C1', ARRAY[232, 217, 193], 'warm', 3),
    ('150 - Light Medium with neutral undertones', '150', '#E4D5BC', ARRAY[228, 213, 188], 'neutral', 3),
    ...
    ('200 - Light Medium with neutral undertones', '200', '#D6C7A8', ARRAY[214, 199, 168], 'neutral', 4),
    ...
    ('230 - Medium Light with warm undertones', '230', '#CAB89C', ARRAY[202, 184, 156], 'warm', 5),
    ('240 - Medium Light with neutral undertones', '240', '#C6B498', ARRAY[198, 180, 152], 'neutral', 6),
    ('250 - Medium with neutral undertones', '250', '#C1AF93', ARRAY[193, 175, 147], 'neutral', 6),
    ('260 - Medium with warm undertones', '260', '#BDAB8F', ARRAY[189, 171, 143], 'warm', 6),
    ('280 - Medium with cool undertones', '280', '#B5A387', ARRAY[181, 163, 135], 'cool', 7),
    ('290 - Medium with olive undertones', '290', '#B19F83', ARRAY[177, 159, 131], 'olive', 7),
    ('300 - Medium Deep with neutral undertones', '300', '#AD9B7F', ARRAY[173, 155, 127], 'neutral', 7),
    ('310 - Medium Deep with warm undertones', '310', '#A9977B', ARRAY[169, 151, 123], 'warm', 8),
    ('320 - Medium Deep with neutral undertones', '320', '#A59377', ARRAY[165, 147, 119], 'neutral', 8),
    ('330 - Medium Deep with warm undertones', '330', '#A18F73', ARRAY[161, 143, 115], 'warm', 8),
    ('340 - Medium Deep with cool undertones', '340', '#9D8B6F', ARRAY[157, 139, 111], 'cool', 8),
    ('350 - Medium Deep with neutral undertones', '350', '#99876B', ARRAY[153, 135, 107], 'neutral', 9),
    ('360 - Medium Deep with warm undertones', '360', '#958367', ARRAY[149, 131, 103], 'warm', 9),
    ('370 - Deep with neutral undertones', '370', '#917F63', ARRAY[145, 127, 99], 'neutral', 9),
    ('380 - Deep with warm undertones', '380', '#8D7B5F', ARRAY[141, 123, 95], 'warm', 9),
    ('385 - Deep with cool undertones', '385', '#89775B', ARRAY[137, 119, 91], 'cool', 10),
    ('390 - Deep with neutral undertones', '390', '#857357', ARRAY[133, 115, 87], 'neutral', 10),
    ('400 - Deep with warm undertones', '400', '#816F53', ARRAY[129, 111, 83], 'warm', 10),
    ('410 - Deep with neutral undertones', '410', '#7D6B4F', ARRAY[125, 107, 79], 'neutral', 10),
    ('420 - Deep with warm undertones', '420', '#79674B', ARRAY[121, 103, 75], 'warm', 10),
    ('430 - Deep with cool undertones', '430', '#756347', ARRAY[117, 99, 71], 'cool', 10),
    ('440 - Deep with neutral undertones', '440', '#715F43', ARRAY[113, 95, 67], 'neutral', 10),
    ('445 - Deep with warm undertones', '445', '#6D5B3F', ARRAY[109, 91, 63], 'warm', 10),
    ('450 - Very Deep with neutral undertones', '450', '#69573B', ARRAY[105, 87, 59], 'neutral', 10),
    ('460 - Very Deep with warm undertones', '460', '#655337', ARRAY[101, 83, 55], 'warm', 10),
    ('470 - Very Deep with cool undertones', '470', '#614F33', ARRAY[97, 79, 51], 'cool', 10),
    ('480 - Very Deep with neutral undertones', '480', '#5D4B2F', ARRAY[93, 75, 47], 'neutral', 10),
    ('490 - Very Deep with warm undertones', '490', '#59472B', ARRAY[89, 71, 43], 'warm', 10),
    ('498 - Very Deep with neutral undertones', '498', '#554327', ARRAY[85, 67, 39], 'neutral', 10)
...
CROSS JOIN (
  VALUES 
    ...
    ('2 Fair', '2', '#F2E3D0', ARRAY[242, 227, 208], 'cool', 1),
    ('3 Fair', '3', '#EFE0CD', ARRAY[239, 224, 205], 'warm', 2),
    ('4 Fair', '4', '#EBDCC8', ARRAY[235, 220, 200], 'neutral', 2),
    ('5 Fair', '5', '#E8D9C5', ARRAY[232, 217, 197], 'warm', 3),
    ('6 Medium', '6', '#E4D5C0', ARRAY[228, 213, 192], 'neutral', 3),
