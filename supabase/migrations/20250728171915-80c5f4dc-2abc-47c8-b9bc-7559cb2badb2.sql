-- Create missing enums for foundation products
CREATE TYPE coverage_type AS ENUM ('light', 'medium', 'full', 'buildable');
CREATE TYPE finish_type AS ENUM ('matte', 'natural', 'dewy', 'satin', 'radiant', 'luminous');

-- Database Synchronization Migration (Fixed)
